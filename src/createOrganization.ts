...
const admins: string[] = ["jeremy@in3dTech.com"]; // enter admin email addresses here
const teachers: string[] = ["jeremy@in3dTech.com"]; // enter teacher email addresses here

export async function createOrg({ mongo }: any) {
  if (!mongo) {
